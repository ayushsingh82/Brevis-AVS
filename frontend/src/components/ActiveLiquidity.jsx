...
const ActiveLiquidity = () => {
  return (
    <section className="pt-10 pb-20 md:pb-10 px-8 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip min-h-screen w-screen">
      <h1 className="text-3xl font-bold text-blue-500 text-center mb-6">Active Liquidity Management Hook</h1>
      ...
      <div className="flex justify-center mb-10">
        <img 
          src="../../public/LiquidityManagement.png"  // Replace with the correct image path if different
